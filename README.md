...
i care about what gets built and why — not just how.
that's what's pushing me from engineering into product.
i want to be in the room where decisions are made,
and technical enough to know when they're wrong._
```
...
![LangChain](https://img.shields.io/badge/LangChain-72243E?style=flat-square)
![AutoGen](https://img.shields.io/badge/AutoGen-72243E?style=flat-square)
![OpenAI API](https://img.shields.io/badge/OpenAI_API-72243E?style=flat-square)
![Claude API](https://img.shields.io/badge/Claude_API-72243E?style=flat-square)
![Workers AI](https://img.shields.io/badge/Workers_AI-72243E?style=flat-square)
![Vector Embeddings](https://img.shields.io/badge/Vector_Embeddings-72243E?style=flat-square)
...
![Roadmapping](https://img.shields.io/badge/Roadmapping-534AB7?style=flat-square)
![PRDs](https://img.shields.io/badge/PRDs-534AB7?style=flat-square)
![Metrics & KPIs](https://img.shields.io/badge/Metrics_%26_KPIs-3C3489?style=flat-square)
![Agile](https://img.shields.io/badge/Agile-3C3489?style=flat-square)
...
|---|---|---|
| [**SignalNote**](https://github.com/MChakrabartyy/SignalNote) | agentic AI pipeline classifies + routes 1000+ feedback signals. cut triage time by 60%. real-time sentiment dashboard for product teams. | Python · Cloudflare Workers AI · RAG · SQL · KV |
| [**CollabCode**](https://github.com/MChakrabartyy/cf_ai_collaborative_debugger) | sub-50ms real-time multiplayer AI debugger. llama 3.3 70B + RAG. CRDTs for zero concurrency conflicts. built + evaluated with Claude Code & Cursor. | TS · Durable Objects · CRDTs · Llama 3.3 70B |
| [**Decoy**](https://github.com/MChakrabartyy) | 93% scam-detection precision. LLM-powered call routing over live streams. 2nd place out of 80+ teams in 24hrs. | Python · Flask · Twilio · OpenAI API |
| [**PillBuddy**](https://github.com/MChakrabartyy) | 97% dispensing accuracy. arduino firmware + openai chatbot. best hardware hack — SunHacks '24. shipped in 24hrs. | C++ (Arduino) · React · OpenAI API |
